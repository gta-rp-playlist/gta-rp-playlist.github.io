...
hideAllButton.addEventListener('click', toggleVisibility);
...
function toggleVisibility() {
    ...
    floatingBox.style.display = areButtonsVisible ? 'block' : 'none';
}
...
if (performance.navigation.type === performance.navigation.TYPE_RELOAD) {
    ...
    // Send each username through the loadSingleTwitchPlayer function
...
// Assume 'floatingBox' is the ID of your floating box
const floatingBox = document.getElementById('floatingBox');
...
document.getElementById('link').addEventListener('click', function() {
    ...
    const textToCopy = `Watch this multiPOV at ${currentUrl}`;
